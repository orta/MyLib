...
// MyLib
#define COCOAPODS_POD_AVAILABLE_MyLib
#define COCOAPODS_VERSION_MAJOR_MyLib 0
#define COCOAPODS_VERSION_MINOR_MyLib 1
#define COCOAPODS_VERSION_PATCH_MyLib 0
